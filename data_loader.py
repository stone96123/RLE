...
class SYSUData(data.Dataset):
    def __init__(self, data_dir,  transform=None, colorIndex = None, thermalIndex = None):
        ...
        train_color_image = np.load(data_dir + 'train_rgb_resized_img192.npy')
        self.train_color_label = np.load(data_dir + 'train_rgb_resized_label192.npy')

        train_thermal_image = np.load(data_dir + 'train_ir_resized_img192.npy')
        self.train_thermal_label = np.load(data_dir + 'train_ir_resized_label192.npy')
